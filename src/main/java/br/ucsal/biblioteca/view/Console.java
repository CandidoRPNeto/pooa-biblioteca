...
public class Console {
	...
	private boolean validateNameLength(Object objeto) {
		...
		for (Field atributo : atributos) {
			...
			try {
				...
				if (atributo.isAnnotationPresent(NameLength.class)) {
